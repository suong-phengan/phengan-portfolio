...
import Typescript from '../public/assets/skills/ts-logo.png';
...
import Docker from '../public/assets/skills/docker-logo.png'
import Golang from '../public/assets/skills/go-logo.png'
import Dialogflow from '../public/assets/skills/dialogflow.png'
      ...
      <div className='max-w-[1240px] mx-auto flex flex-col justify-center h-full'>
        ...
        <div className='grid grid-cols-2 lg:grid-cols-4 gap-8'>
          ...
          <div className='p-6 shadow-xl rounded-xl hover:scale-105 ease-in duration-300'>
            <div className='grid grid-cols-2 gap-4 justify-center items-center'>
              <div className='m-auto'>
                <Image src={Dialogflow} width='64px' height='64px' alt='/' />
              </div>
              <div className='flex flex-col items-center justify-center'>
                <h3>Dialogflow</h3>
              </div>
